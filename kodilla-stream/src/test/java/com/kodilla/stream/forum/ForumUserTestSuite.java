...
public class ForumUserTestSuite {
    ...
    public void testGetLocationOfFriends() {
        ...
        //Then
        //Assert.assertEquals(4,user3.getLocationsOfFriends().size());
        //user 1,7,9 są z Waszyngtonu, dlatego są dodawane tylko raz (HashSet), user2 jest z Miami. To spodziewana jest 2?
    }
